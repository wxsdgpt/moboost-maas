...
function chipColor(v: UploadedAssetValidation): string {
  if (!v.ok) return 'bg-rose-900/40 border-rose-600/60 text-rose-200'
  if (v.warnings > 0) return 'bg-amber-900/40 border-amber-600/60 text-amber-200'
    ...
    <div className="mt-2 space-y-1">
      <div className="flex flex-wrap gap-1.5">
        ...
        {validations.length > 4 && (
          <button
            type="button"
            className="text-[11px] text-neutral-400 hover:text-neutral-100 underline"
